...
CREATE OR REPLACE TABLE FUNCTION `autobet-470818.autobet.tf_trifecta_pl_from_tote`(
...
WITH r_ranked AS (
          ...
          SELECT r1.product_id,
                 ...
                 r3.rid AS h3,
                 (r1.strength/t.sum_s) *
                 (r2.strength/(t.sum_s - r1.strength)) *
                 (r3.strength/(t.sum_s - r1.strength - r2.strength)) AS p
          FROM r r1
          JOIN r r2 ON r2.rid != r1.rid AND r2.product_id = r1.product_id
          JOIN r r3 ON r3.rid NOT IN (r1.rid, r2.rid) AND r3.product_id = r1.product_id
